...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_A_SalesOrderScheduleLineType")]
    public partial class CollectionOfASalesOrderScheduleLineType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfASalesOrderScheduleLineType" /> class.
        /// </summary>
        ...
        public CollectionOfASalesOrderScheduleLineType(string count = default(string), List<APISALESORDERSRVASalesOrderScheduleLineType> results = default(List<APISALESORDERSRVASalesOrderScheduleLineType>))
        {
            this.Count = count;
