...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderPartnerAddressType-update")]
    public partial class APISALESORDERSRVASalesOrderPartnerAddressTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderPartnerAddressTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderPartnerAddressTypeUpdate(string correspondenceLanguage = default(string), string addresseeFullName = default(string), string organizationName1 = default(string), string organizationName2 = default(string), string organizationName3 = default(string), string organizationName4 = default(string), string cityName = default(string), string districtName = default(string), string postalCode = default(string), string streetPrefixName1 = default(string), string streetPrefixName2 = default(string), string streetName = default(string), string streetSuffixName1 = default(string), string streetSuffixName2 = default(string), string houseNumber = default(string), string country = default(string), string region = default(string), string formOfAddress = default(string), string taxJurisdiction = default(string), string transportZone = default(string), string pOBox = default(string), string pOBoxPostalCode = default(string), string emailAddress = default(string), string mobilePhoneCountry = default(string), string mobileNumber = default(string), string phoneNumberCountry = default(string), string phoneNumber = default(string), string phoneExtensionNumber = default(string), string faxNumberCountry = default(string), string faxAreaCodeSubscriberNumber = default(string), string faxExtensionNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderPartnerAddressTypeUpdate {\n");
