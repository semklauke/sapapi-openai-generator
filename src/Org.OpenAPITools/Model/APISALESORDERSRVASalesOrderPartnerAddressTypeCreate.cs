...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderPartnerAddressType-create")]
    public partial class APISALESORDERSRVASalesOrderPartnerAddressTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderPartnerAddressTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderPartnerAddressTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderPartnerAddressTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderPartnerAddressTypeCreate(string salesOrder = default(string), string partnerFunction = default(string), string addressRepresentationCode = default(string), string correspondenceLanguage = default(string), string addresseeFullName = default(string), string organizationName1 = default(string), string organizationName2 = default(string), string organizationName3 = default(string), string organizationName4 = default(string), string cityName = default(string), string districtName = default(string), string postalCode = default(string), string streetPrefixName1 = default(string), string streetPrefixName2 = default(string), string streetName = default(string), string streetSuffixName1 = default(string), string streetSuffixName2 = default(string), string houseNumber = default(string), string country = default(string), string region = default(string), string formOfAddress = default(string), string taxJurisdiction = default(string), string transportZone = default(string), string pOBox = default(string), string pOBoxPostalCode = default(string), string emailAddress = default(string), string mobilePhoneCountry = default(string), string mobileNumber = default(string), string phoneNumberCountry = default(string), string phoneNumber = default(string), string phoneExtensionNumber = default(string), string faxNumberCountry = default(string), string faxAreaCodeSubscriberNumber = default(string), string faxExtensionNumber = default(string), APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate toPartner = default(APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate))
        {
            // to ensure "salesOrder" is required (not null)
            if (salesOrder == null)
            {
                throw new ArgumentNullException("salesOrder is a required property for APISALESORDERSRVASalesOrderPartnerAddressTypeCreate and cannot be null");
            }
            this.SalesOrder = salesOrder;
            // to ensure "partnerFunction" is required (not null)
            if (partnerFunction == null)
            {
                throw new ArgumentNullException("partnerFunction is a required property for APISALESORDERSRVASalesOrderPartnerAddressTypeCreate and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("addressRepresentationCode is a required property for APISALESORDERSRVASalesOrderPartnerAddressTypeCreate and cannot be null");
            }
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate ToPartner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderPartnerAddressTypeCreate {\n");
