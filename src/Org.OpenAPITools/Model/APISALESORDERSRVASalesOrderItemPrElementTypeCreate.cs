...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemPrElementType-create")]
    public partial class APISALESORDERSRVASalesOrderItemPrElementTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPrElementTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderItemPrElementTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPrElementTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemPrElementTypeCreate(string pricingProcedureStep = default(string), string pricingProcedureCounter = default(string), string conditionType = default(string), decimal? conditionRateValue = default(decimal?), string conditionCurrency = default(string), decimal? conditionQuantity = default(decimal?), string conditionQuantityUnit = default(string), string conditionQuantitySAPUnit = default(string), string conditionQuantityISOUnit = default(string), string transactionCurrency = default(string), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
            ...
            {
                throw new ArgumentNullException("pricingProcedureCounter is a required property for APISALESORDERSRVASalesOrderItemPrElementTypeCreate and cannot be null");
            }
