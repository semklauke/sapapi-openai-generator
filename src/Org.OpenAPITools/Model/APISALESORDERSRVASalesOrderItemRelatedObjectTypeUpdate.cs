...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemRelatedObjectType-update")]
    public partial class APISALESORDERSRVASalesOrderItemRelatedObjectTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemRelatedObjectTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemRelatedObjectTypeUpdate(string sDDocumentRelatedObjectType = default(string), string sDDocRelatedObjectSystem = default(string), string sDDocRelatedObjectReference1 = default(string), string sDDocRelatedObjectReference2 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItemRelatedObjectTypeUpdate {\n");
