...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemBillingPlanType-create")]
    public partial class APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate(bool? billingPlanIsInHeader = default(bool?), string billingPlanStartDate = default(string), string billingPlanStartDateRule = default(string), string referenceBillingPlan = default(string), APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem toBillingPlanItem = default(APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
        ...
        */
        ...
        public APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem ToBillingPlanItem { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate {\n");
