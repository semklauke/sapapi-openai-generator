...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItmSubsqntProcFlowType-create")]
    public partial class APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate" /> class.
        /// </summary>
        /// <param name="salesOrder">Preceding sales and distribution document (required).</param>
        /// <param name="salesOrderItem">Preceding Item of an SD Document (required).</param>
        ...
        public APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate(string salesOrder = default(string), string salesOrderItem = default(string), Guid docRelationshipUUID = default(Guid), string subsequentDocument = default(string), string subsequentDocumentItem = default(string), string subsequentDocumentCategory = default(string), string processFlowLevel = default(string), string relatedProcFlowDocStsFieldName = default(string), string sDProcessStatus = default(string), string accountingTransferStatus = default(string), string prelimBillingDocumentStatus = default(string), string subsqntDocItmPrecdgDocument = default(string), string subsqntDocItmPrecdgDocItem = default(string), string subsqntDocItmPrecdgDocCategory = default(string), string creationDate = default(string), string creationTime = default(string), string lastChangeDate = default(string), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
            // to ensure "salesOrder" is required (not null)
            if (salesOrder == null)
            {
                throw new ArgumentNullException("salesOrder is a required property for APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate and cannot be null");
            }
            this.SalesOrder = salesOrder;
            // to ensure "salesOrderItem" is required (not null)
            if (salesOrderItem == null)
            {
                throw new ArgumentNullException("salesOrderItem is a required property for APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItmSubsqntProcFlowTypeCreate {\n");
