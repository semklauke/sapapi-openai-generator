...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_A_SalesOrderHeaderPartnerType")]
    public partial class CollectionOfASalesOrderHeaderPartnerType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfASalesOrderHeaderPartnerType" /> class.
        /// </summary>
        ...
        public CollectionOfASalesOrderHeaderPartnerType(string count = default(string), List<APISALESORDERSRVASalesOrderHeaderPartnerType> results = default(List<APISALESORDERSRVASalesOrderHeaderPartnerType>))
        {
            this.Count = count;
