...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderType")]
    public partial class APISALESORDERSRVASalesOrderType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderType" /> class.
        /// </summary>
        /// <param name="salesOrder">salesOrder.</param>
        /// <param name="salesOrderType">salesOrderType.</param>
        /// <param name="salesOrderTypeInternalCode">Language key for sales document type.</param>
        ...
        /// <param name="createdByUser">Name of Person Responsible for Creating the Object.</param>
        /// <param name="lastChangeDate">Last Changed On.</param>
        /// <param name="senderBusinessSystemName">External Business System ID.</param>
        /// <param name="externalDocumentID">externalDocumentID.</param>
        /// <param name="lastChangeDateTime">UTC Time Stamp in Long Form (YYYYMMDDhhmmssmmmuuun).</param>
        /// <param name="externalDocLastChangeDateTime">Timestamp for Revision of External Calls.</param>
        ...
        /// <param name="totalNetAmount">Net Value of the Sales Document in Document Currency.</param>
        /// <param name="overallDeliveryStatus">Delivery Status (All Items).</param>
        /// <param name="totalBlockStatus">Overall Block Status (Header).</param>
        /// <param name="overallOrdReltdBillgStatus">Order-Related Billing Status (All Items).</param>
        /// <param name="overallSDDocReferenceStatus">Reference Status (All Items).</param>
        ...
        /// <param name="referenceSDDocumentCategory">referenceSDDocumentCategory.</param>
        ...
        /// <param name="salesOrderApprovalReason">Approval Request Reason ID.</param>
        /// <param name="salesDocApprovalStatus">Document Approval Status.</param>
        /// <param name="overallSDProcessStatus">Overall Processing Status (Header/All Items).</param>
        /// <param name="totalCreditCheckStatus">Overall Status of Credit Checks.</param>
        /// <param name="overallTotalDeliveryStatus">Overall Delivery Status (All Items).</param>
        /// <param name="overallSDDocumentRejectionSts">Rejection Status (All Items).</param>
        ...
        /// <param name="toPaymentPlanItemDetails">toPaymentPlanItemDetails.</param>
        /// <param name="toPrecedingProcFlowDoc">toPrecedingProcFlowDoc.</param>
        /// <param name="toPricingElement">toPricingElement.</param>
        /// <param name="toRelatedObject">toRelatedObject.</param>
        /// <param name="toSubsequentProcFlowDoc">toSubsequentProcFlowDoc.</param>
        /// <param name="toText">toText.</param>
        public APISALESORDERSRVASalesOrderType(string salesOrder = default(string), string salesOrderType = default(string), string salesOrderTypeInternalCode = default(string), string salesOrganization = default(string), string distributionChannel = default(string), string organizationDivision = default(string), string salesGroup = default(string), string salesOffice = default(string), string salesDistrict = default(string), string soldToParty = default(string), string creationDate = default(string), string createdByUser = default(string), string lastChangeDate = default(string), string senderBusinessSystemName = default(string), string externalDocumentID = default(string), string lastChangeDateTime = default(string), string externalDocLastChangeDateTime = default(string), string purchaseOrderByCustomer = default(string), string purchaseOrderByShipToParty = default(string), string customerPurchaseOrderType = default(string), string customerPurchaseOrderDate = default(string), string salesOrderDate = default(string), decimal? totalNetAmount = default(decimal?), string overallDeliveryStatus = default(string), string totalBlockStatus = default(string), string overallOrdReltdBillgStatus = default(string), string overallSDDocReferenceStatus = default(string), string transactionCurrency = default(string), string sDDocumentReason = default(string), string pricingDate = default(string), decimal? priceDetnExchangeRate = default(decimal?), string billingPlan = default(string), string requestedDeliveryDate = default(string), string shippingCondition = default(string), bool? completeDeliveryIsDefined = default(bool?), string shippingType = default(string), string headerBillingBlockReason = default(string), string deliveryBlockReason = default(string), string deliveryDateTypeRule = default(string), string incotermsClassification = default(string), string incotermsTransferLocation = default(string), string incotermsLocation1 = default(string), string incotermsLocation2 = default(string), string incotermsVersion = default(string), string customerPriceGroup = default(string), string priceListType = default(string), string customerPaymentTerms = default(string), string paymentMethod = default(string), string fixedValueDate = default(string), string assignmentReference = default(string), string referenceSDDocument = default(string), string referenceSDDocumentCategory = default(string), string accountingDocExternalReference = default(string), string customerAccountAssignmentGroup = default(string), decimal? accountingExchangeRate = default(decimal?), string customerGroup = default(string), string additionalCustomerGroup1 = default(string), string additionalCustomerGroup2 = default(string), string additionalCustomerGroup3 = default(string), string additionalCustomerGroup4 = default(string), string additionalCustomerGroup5 = default(string), bool? slsDocIsRlvtForProofOfDeliv = default(bool?), string customerTaxClassification1 = default(string), string customerTaxClassification2 = default(string), string customerTaxClassification3 = default(string), string customerTaxClassification4 = default(string), string customerTaxClassification5 = default(string), string customerTaxClassification6 = default(string), string customerTaxClassification7 = default(string), string customerTaxClassification8 = default(string), string customerTaxClassification9 = default(string), string taxDepartureCountry = default(string), string vATRegistrationCountry = default(string), string salesOrderApprovalReason = default(string), string salesDocApprovalStatus = default(string), string overallSDProcessStatus = default(string), string totalCreditCheckStatus = default(string), string overallTotalDeliveryStatus = default(string), string overallSDDocumentRejectionSts = default(string), string billingDocumentDate = default(string), string contractAccount = default(string), string additionalValueDays = default(string), string customerPurchaseOrderSuplmnt = default(string), string servicesRenderedDate = default(string), APISALESORDERSRVASalesOrderBillingPlanType toBillingPlan = default(APISALESORDERSRVASalesOrderBillingPlanType), APISALESORDERSRVASalesOrderTypeToItem toItem = default(APISALESORDERSRVASalesOrderTypeToItem), APISALESORDERSRVASalesOrderTypeToPartner toPartner = default(APISALESORDERSRVASalesOrderTypeToPartner), APISALESORDERSRVASalesOrderTypeToPaymentPlanItemDetails toPaymentPlanItemDetails = default(APISALESORDERSRVASalesOrderTypeToPaymentPlanItemDetails), APISALESORDERSRVASalesOrderTypeToPrecedingProcFlowDoc toPrecedingProcFlowDoc = default(APISALESORDERSRVASalesOrderTypeToPrecedingProcFlowDoc), APISALESORDERSRVASalesOrderTypeToPricingElement toPricingElement = default(APISALESORDERSRVASalesOrderTypeToPricingElement), APISALESORDERSRVASalesOrderTypeToRelatedObject toRelatedObject = default(APISALESORDERSRVASalesOrderTypeToRelatedObject), APISALESORDERSRVASalesOrderTypeToSubsequentProcFlowDoc toSubsequentProcFlowDoc = default(APISALESORDERSRVASalesOrderTypeToSubsequentProcFlowDoc), APISALESORDERSRVASalesOrderTypeToText toText = default(APISALESORDERSRVASalesOrderTypeToText))
        {
            this.SalesOrder = salesOrder;
            this.SalesOrderType = salesOrderType;
            this.SalesOrderTypeInternalCode = salesOrderTypeInternalCode;
            ...
            this.ToPrecedingProcFlowDoc = toPrecedingProcFlowDoc;
            this.ToPricingElement = toPricingElement;
            this.ToRelatedObject = toRelatedObject;
            this.ToSubsequentProcFlowDoc = toSubsequentProcFlowDoc;
            this.ToText = toText;
        }
        ...
        /// </summary>
        /// <value>Language key for sales document type</value>
        [DataMember(Name = "SalesOrderTypeInternalCode", EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>Name of Person Responsible for Creating the Object</value>
        ...
        */
        ...
        /// </summary>
        /// <value>External Business System ID</value>
        [DataMember(Name = "SenderBusinessSystemName", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>UTC Time Stamp in Long Form (YYYYMMDDhhmmssmmmuuun)</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Timestamp for Revision of External Calls</value>
        /*
        <example>/Date(1492098664000)/</example>
        */
        [DataMember(Name = "ExternalDocLastChangeDateTime", EmitDefaultValue = true)]
        public string ExternalDocLastChangeDateTime { get; set; }
        ...
        */
        ...
        /// </summary>
        /// <value>Net Value of the Sales Document in Document Currency</value>
        /*
        <example>0</example>
        */
        ...
        /// </summary>
        /// <value>Delivery Status (All Items)</value>
        [DataMember(Name = "OverallDeliveryStatus", EmitDefaultValue = true)]
        public string OverallDeliveryStatus { get; set; }

        /// <summary>
        /// Overall Block Status (Header)
        /// </summary>
        /// <value>Overall Block Status (Header)</value>
        [DataMember(Name = "TotalBlockStatus", EmitDefaultValue = true)]
        public string TotalBlockStatus { get; set; }

        /// <summary>
        /// Order-Related Billing Status (All Items)
        /// </summary>
        /// <value>Order-Related Billing Status (All Items)</value>
        [DataMember(Name = "OverallOrdReltdBillgStatus", EmitDefaultValue = true)]
        public string OverallOrdReltdBillgStatus { get; set; }

        /// <summary>
        /// Reference Status (All Items)
        /// </summary>
        /// <value>Reference Status (All Items)</value>
        [DataMember(Name = "OverallSDDocReferenceStatus", EmitDefaultValue = true)]
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets ReferenceSDDocumentCategory
        /// </summary>
        [DataMember(Name = "ReferenceSDDocumentCategory", EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>Approval Request Reason ID</value>
        [DataMember(Name = "SalesOrderApprovalReason", EmitDefaultValue = true)]
        public string SalesOrderApprovalReason { get; set; }

        /// <summary>
        /// Document Approval Status
        /// </summary>
        /// <value>Document Approval Status</value>
        [DataMember(Name = "SalesDocApprovalStatus", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Overall Status of Credit Checks</value>
        [DataMember(Name = "TotalCreditCheckStatus", EmitDefaultValue = true)]
        public string TotalCreditCheckStatus { get; set; }

        /// <summary>
        /// Overall Delivery Status (All Items)
        /// </summary>
        /// <value>Overall Delivery Status (All Items)</value>
        [DataMember(Name = "OverallTotalDeliveryStatus", EmitDefaultValue = true)]
        public string OverallTotalDeliveryStatus { get; set; }

        /// <summary>
        /// Rejection Status (All Items)
        /// </summary>
        /// <value>Rejection Status (All Items)</value>
        [DataMember(Name = "OverallSDDocumentRejectionSts", EmitDefaultValue = true)]
        ...
        */
        ...
        public APISALESORDERSRVASalesOrderBillingPlanType ToBillingPlan { get; set; }

        /// <summary>
        /// Gets or Sets ToItem
        /// </summary>
        [DataMember(Name = "to_Item", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToItem ToItem { get; set; }

        /// <summary>
        /// Gets or Sets ToPartner
        /// </summary>
        [DataMember(Name = "to_Partner", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToPartner ToPartner { get; set; }

        /// <summary>
        /// Gets or Sets ToPaymentPlanItemDetails
        /// </summary>
        [DataMember(Name = "to_PaymentPlanItemDetails", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToPaymentPlanItemDetails ToPaymentPlanItemDetails { get; set; }

        /// <summary>
        /// Gets or Sets ToPrecedingProcFlowDoc
        /// </summary>
        [DataMember(Name = "to_PrecedingProcFlowDoc", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToPrecedingProcFlowDoc ToPrecedingProcFlowDoc { get; set; }

        /// <summary>
        /// Gets or Sets ToPricingElement
        /// </summary>
        [DataMember(Name = "to_PricingElement", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToPricingElement ToPricingElement { get; set; }

        /// <summary>
        /// Gets or Sets ToRelatedObject
        /// </summary>
        [DataMember(Name = "to_RelatedObject", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToRelatedObject ToRelatedObject { get; set; }

        /// <summary>
        /// Gets or Sets ToSubsequentProcFlowDoc
        /// </summary>
        [DataMember(Name = "to_SubsequentProcFlowDoc", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToSubsequentProcFlowDoc ToSubsequentProcFlowDoc { get; set; }

        /// <summary>
        /// Gets or Sets ToText
        /// </summary>
        [DataMember(Name = "to_Text", EmitDefaultValue = false)]
        public APISALESORDERSRVASalesOrderTypeToText ToText { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SalesOrderTypeInternalCode: ").Append(SalesOrderTypeInternalCode).Append("\n");
            ...
            sb.Append("  SenderBusinessSystemName: ").Append(SenderBusinessSystemName).Append("\n");
            ...
            sb.Append("  ExternalDocLastChangeDateTime: ").Append(ExternalDocLastChangeDateTime).Append("\n");
            ...
            sb.Append("  OverallDeliveryStatus: ").Append(OverallDeliveryStatus).Append("\n");
            sb.Append("  TotalBlockStatus: ").Append(TotalBlockStatus).Append("\n");
            sb.Append("  OverallOrdReltdBillgStatus: ").Append(OverallOrdReltdBillgStatus).Append("\n");
            sb.Append("  OverallSDDocReferenceStatus: ").Append(OverallSDDocReferenceStatus).Append("\n");
            ...
            sb.Append("  ReferenceSDDocumentCategory: ").Append(ReferenceSDDocumentCategory).Append("\n");
            ...
            sb.Append("  SalesOrderApprovalReason: ").Append(SalesOrderApprovalReason).Append("\n");
            sb.Append("  SalesDocApprovalStatus: ").Append(SalesDocApprovalStatus).Append("\n");
            sb.Append("  OverallSDProcessStatus: ").Append(OverallSDProcessStatus).Append("\n");
            sb.Append("  TotalCreditCheckStatus: ").Append(TotalCreditCheckStatus).Append("\n");
            sb.Append("  OverallTotalDeliveryStatus: ").Append(OverallTotalDeliveryStatus).Append("\n");
            sb.Append("  OverallSDDocumentRejectionSts: ").Append(OverallSDDocumentRejectionSts).Append("\n");
            ...
            sb.Append("  ToPaymentPlanItemDetails: ").Append(ToPaymentPlanItemDetails).Append("\n");
            sb.Append("  ToPrecedingProcFlowDoc: ").Append(ToPrecedingProcFlowDoc).Append("\n");
            sb.Append("  ToPricingElement: ").Append(ToPricingElement).Append("\n");
            sb.Append("  ToRelatedObject: ").Append(ToRelatedObject).Append("\n");
            sb.Append("  ToSubsequentProcFlowDoc: ").Append(ToSubsequentProcFlowDoc).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SalesOrderTypeInternalCode (string) maxLength
            if (this.SalesOrderTypeInternalCode != null && this.SalesOrderTypeInternalCode.Length > 4)
            {
                yield return new ValidationResult("Invalid value for SalesOrderTypeInternalCode, length must be less than 4.", new [] { "SalesOrderTypeInternalCode" });
            }
            ...
            // SenderBusinessSystemName (string) maxLength
            if (this.SenderBusinessSystemName != null && this.SenderBusinessSystemName.Length > 60)
            {
                yield return new ValidationResult("Invalid value for SenderBusinessSystemName, length must be less than 60.", new [] { "SenderBusinessSystemName" });
            }

            // ExternalDocumentID (string) maxLength
            if (this.ExternalDocumentID != null && this.ExternalDocumentID.Length > 40)
            {
                yield return new ValidationResult("Invalid value for ExternalDocumentID, length must be less than 40.", new [] { "ExternalDocumentID" });
            }
            ...
            // OverallDeliveryStatus (string) maxLength
            if (this.OverallDeliveryStatus != null && this.OverallDeliveryStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for OverallDeliveryStatus, length must be less than 1.", new [] { "OverallDeliveryStatus" });
            }

            // TotalBlockStatus (string) maxLength
            if (this.TotalBlockStatus != null && this.TotalBlockStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for TotalBlockStatus, length must be less than 1.", new [] { "TotalBlockStatus" });
            }

            // OverallOrdReltdBillgStatus (string) maxLength
            if (this.OverallOrdReltdBillgStatus != null && this.OverallOrdReltdBillgStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for OverallOrdReltdBillgStatus, length must be less than 1.", new [] { "OverallOrdReltdBillgStatus" });
            }

            // OverallSDDocReferenceStatus (string) maxLength
            if (this.OverallSDDocReferenceStatus != null && this.OverallSDDocReferenceStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for OverallSDDocReferenceStatus, length must be less than 1.", new [] { "OverallSDDocReferenceStatus" });
            }
            ...
            // ReferenceSDDocumentCategory (string) maxLength
            if (this.ReferenceSDDocumentCategory != null && this.ReferenceSDDocumentCategory.Length > 4)
            {
                yield return new ValidationResult("Invalid value for ReferenceSDDocumentCategory, length must be less than 4.", new [] { "ReferenceSDDocumentCategory" });
            }
            ...
            // SalesOrderApprovalReason (string) maxLength
            if (this.SalesOrderApprovalReason != null && this.SalesOrderApprovalReason.Length > 4)
            {
                yield return new ValidationResult("Invalid value for SalesOrderApprovalReason, length must be less than 4.", new [] { "SalesOrderApprovalReason" });
            }

            // SalesDocApprovalStatus (string) maxLength
            if (this.SalesDocApprovalStatus != null && this.SalesDocApprovalStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for SalesDocApprovalStatus, length must be less than 1.", new [] { "SalesDocApprovalStatus" });
            }
            ...
            // TotalCreditCheckStatus (string) maxLength
            if (this.TotalCreditCheckStatus != null && this.TotalCreditCheckStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for TotalCreditCheckStatus, length must be less than 1.", new [] { "TotalCreditCheckStatus" });
            }

            // OverallTotalDeliveryStatus (string) maxLength
            if (this.OverallTotalDeliveryStatus != null && this.OverallTotalDeliveryStatus.Length > 1)
            {
                yield return new ValidationResult("Invalid value for OverallTotalDeliveryStatus, length must be less than 1.", new [] { "OverallTotalDeliveryStatus" });
            }

            // OverallSDDocumentRejectionSts (string) maxLength
            if (this.OverallSDDocumentRejectionSts != null && this.OverallSDDocumentRejectionSts.Length > 1)
            {
                yield return new ValidationResult("Invalid value for OverallSDDocumentRejectionSts, length must be less than 1.", new [] { "OverallSDDocumentRejectionSts" });
            }
