...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderHeaderPartnerType-create")]
    public partial class APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate(string partnerFunction = default(string), string customer = default(string), string supplier = default(string), string personnel = default(string), string contactPerson = default(string), string addressID = default(string), string vATRegistration = default(string), APISALESORDERSRVASalesOrderHeaderPartnerTypeCreateToAddress toAddress = default(APISALESORDERSRVASalesOrderHeaderPartnerTypeCreateToAddress), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate))
        {
            // to ensure "partnerFunction" is required (not null)
            if (partnerFunction == null)
            {
                throw new ArgumentNullException("partnerFunction is a required property for APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate and cannot be null");
            }
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerTypeCreateToAddress ToAddress { get; set; }
