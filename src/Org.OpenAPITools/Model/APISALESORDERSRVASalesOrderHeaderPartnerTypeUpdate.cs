...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderHeaderPartnerType-update")]
    public partial class APISALESORDERSRVASalesOrderHeaderPartnerTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderHeaderPartnerTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerTypeUpdate(string customer = default(string), string supplier = default(string), string personnel = default(string), string contactPerson = default(string), string addressID = default(string), string vATRegistration = default(string))
        {
