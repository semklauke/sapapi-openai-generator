...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemPartnerType-update")]
    public partial class APISALESORDERSRVASalesOrderItemPartnerTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPartnerTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemPartnerTypeUpdate(string customer = default(string), string supplier = default(string), string personnel = default(string), string contactPerson = default(string), string addressID = default(string), string vATRegistration = default(string))
        {
