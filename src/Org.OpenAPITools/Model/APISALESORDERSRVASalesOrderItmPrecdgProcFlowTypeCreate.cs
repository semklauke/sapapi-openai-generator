...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItmPrecdgProcFlowType-create")]
    public partial class APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate" /> class.
        /// </summary>
        /// <param name="salesOrder">Subsequent Sales and Distribution Document (required).</param>
        /// <param name="salesOrderItem">Subsequent Item of an SD Document (required).</param>
        ...
        public APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate(string salesOrder = default(string), string salesOrderItem = default(string), Guid docRelationshipUUID = default(Guid), string precedingDocument = default(string), string precedingDocumentItem = default(string), string precedingDocumentCategory = default(string), string processFlowLevel = default(string), string relatedProcFlowDocStsFieldName = default(string), string sDProcessStatus = default(string), string accountingTransferStatus = default(string), string prelimBillingDocumentStatus = default(string), string creationDate = default(string), string creationTime = default(string), string lastChangeDate = default(string), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
            // to ensure "salesOrder" is required (not null)
            if (salesOrder == null)
            {
                throw new ArgumentNullException("salesOrder is a required property for APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate and cannot be null");
            }
            this.SalesOrder = salesOrder;
            // to ensure "salesOrderItem" is required (not null)
            if (salesOrderItem == null)
            {
                throw new ArgumentNullException("salesOrderItem is a required property for APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate {\n");
