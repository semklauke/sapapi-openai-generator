...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderSubsqntProcFlowType")]
    public partial class APISALESORDERSRVASalesOrderSubsqntProcFlowType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderSubsqntProcFlowType" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderSubsqntProcFlowType(string salesOrder = default(string), Guid docRelationshipUUID = default(Guid), string subsequentDocument = default(string), string subsequentDocumentCategory = default(string), string processFlowLevel = default(string), string overallSDProcessStatus = default(string), string creationDate = default(string), string creationTime = default(string), string lastChangeDate = default(string), APISALESORDERSRVASalesOrderType toSalesOrder = default(APISALESORDERSRVASalesOrderType))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderSubsqntProcFlowType {\n");
