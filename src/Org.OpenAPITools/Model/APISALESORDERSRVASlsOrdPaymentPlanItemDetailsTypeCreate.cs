...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SlsOrdPaymentPlanItemDetailsType-create")]
    public partial class APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate" /> class.
        /// </summary>
        /// <param name="paymentPlanItem">Item for billing plan/invoice plan/payment cards (required).</param>
        ...
        public APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate(string paymentPlanItem = default(string), string electronicPaymentType = default(string), string electronicPayment = default(string), string ePaytValidityStartDate = default(string), string ePaytValidityEndDate = default(string), string electronicPaymentHolderName = default(string), decimal? authorizedAmountInAuthznCrcy = default(decimal?), string authorizationByDigitalPaytSrvc = default(string), string ePaytByDigitalPaymentSrvc = default(string), string paymentServiceProvider = default(string), string paymentByPaymentServicePrvdr = default(string), string transactionByPaytSrvcPrvdr = default(string), string merchantByClearingHouse = default(string), string paymentCardAuthznRelationID = default(string), decimal? maximumToBeAuthorizedAmount = default(decimal?), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate))
        {
            // to ensure "paymentPlanItem" is required (not null)
            if (paymentPlanItem == null)
            {
                throw new ArgumentNullException("paymentPlanItem is a required property for APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate and cannot be null");
            }
        ...
        [DataMember(Name = "PaymentPlanItem", IsRequired = true, EmitDefaultValue = true)]
