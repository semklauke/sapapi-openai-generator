...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderHeaderPartnerType")]
    public partial class APISALESORDERSRVASalesOrderHeaderPartnerType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderHeaderPartnerType" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerType(string salesOrder = default(string), string partnerFunction = default(string), string partnerFunctionInternalCode = default(string), string customer = default(string), string supplier = default(string), string personnel = default(string), string contactPerson = default(string), string referenceBusinessPartner = default(string), string addressID = default(string), string vATRegistration = default(string), APISALESORDERSRVASalesOrderHeaderPartnerTypeToAddress toAddress = default(APISALESORDERSRVASalesOrderHeaderPartnerTypeToAddress), APISALESORDERSRVASalesOrderType toSalesOrder = default(APISALESORDERSRVASalesOrderType))
        {
        ...
        public APISALESORDERSRVASalesOrderHeaderPartnerTypeToAddress ToAddress { get; set; }
