...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItmPrecdgProcFlowType")]
    public partial class APISALESORDERSRVASalesOrderItmPrecdgProcFlowType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItmPrecdgProcFlowType" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItmPrecdgProcFlowType(string salesOrder = default(string), string salesOrderItem = default(string), Guid docRelationshipUUID = default(Guid), string precedingDocument = default(string), string precedingDocumentItem = default(string), string precedingDocumentCategory = default(string), string processFlowLevel = default(string), string relatedProcFlowDocStsFieldName = default(string), string sDProcessStatus = default(string), string accountingTransferStatus = default(string), string prelimBillingDocumentStatus = default(string), string creationDate = default(string), string creationTime = default(string), string lastChangeDate = default(string), APISALESORDERSRVASalesOrderType toSalesOrder = default(APISALESORDERSRVASalesOrderType), APISALESORDERSRVASalesOrderItemType toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemType))
        {
        ...
        */
        [DataMember(Name = "DocRelationshipUUID", EmitDefaultValue = false)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItmPrecdgProcFlowType {\n");
