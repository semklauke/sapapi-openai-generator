...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_A_SalesOrderHeaderPrElementType")]
    public partial class CollectionOfASalesOrderHeaderPrElementType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfASalesOrderHeaderPrElementType" /> class.
        /// </summary>
        ...
        public CollectionOfASalesOrderHeaderPrElementType(string count = default(string), List<APISALESORDERSRVASalesOrderHeaderPrElementType> results = default(List<APISALESORDERSRVASalesOrderHeaderPrElementType>))
        {
            this.Count = count;
