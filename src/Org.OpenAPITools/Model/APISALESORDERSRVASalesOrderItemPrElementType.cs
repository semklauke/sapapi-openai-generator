...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemPrElementType")]
    public partial class APISALESORDERSRVASalesOrderItemPrElementType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPrElementType" /> class.
        /// </summary>
        ...
        */
        ...
        public string CndnIsRelevantForInvoiceList { get; set; }
        ...
        */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CndnIsRelevantForInvoiceList (string) maxLength
            if (this.CndnIsRelevantForInvoiceList != null && this.CndnIsRelevantForInvoiceList.Length > 1)
            {
                yield return new ValidationResult("Invalid value for CndnIsRelevantForInvoiceList, length must be less than 1.", new [] { "CndnIsRelevantForInvoiceList" });
            }
