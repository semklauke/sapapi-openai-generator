...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_A_SalesOrderItemPartnerType")]
    public partial class CollectionOfASalesOrderItemPartnerType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfASalesOrderItemPartnerType" /> class.
        /// </summary>
        ...
        public CollectionOfASalesOrderItemPartnerType(string count = default(string), List<APISALESORDERSRVASalesOrderItemPartnerType> results = default(List<APISALESORDERSRVASalesOrderItemPartnerType>))
        {
            this.Count = count;
