...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemTextType-create")]
    public partial class APISALESORDERSRVASalesOrderItemTextTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemTextTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderItemTextTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemTextTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemTextTypeCreate(string language = default(string), string longTextID = default(string), string longText = default(string), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for APISALESORDERSRVASalesOrderItemTextTypeCreate and cannot be null");
            }
            this.Language = language;
            // to ensure "longTextID" is required (not null)
            if (longTextID == null)
            {
                throw new ArgumentNullException("longTextID is a required property for APISALESORDERSRVASalesOrderItemTextTypeCreate and cannot be null");
            }
