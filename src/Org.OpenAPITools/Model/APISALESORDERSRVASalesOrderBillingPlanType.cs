...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderBillingPlanType")]
    public partial class APISALESORDERSRVASalesOrderBillingPlanType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderBillingPlanType" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderBillingPlanType(string salesOrder = default(string), string billingPlan = default(string), string billingPlanStartDate = default(string), string billingPlanStartDateRule = default(string), string referenceBillingPlan = default(string), string billingPlanCategory = default(string), string billingPlanType = default(string), string billingPlanEndDate = default(string), string billingPlanEndDateRule = default(string), string billingPlanSearchTerm = default(string), APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem toBillingPlanItem = default(APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem), APISALESORDERSRVASalesOrderType toSalesOrder = default(APISALESORDERSRVASalesOrderType))
        {
        ...
        */
        ...
        public APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem ToBillingPlanItem { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderBillingPlanType {\n");
