...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemBillingPlanType-update")]
    public partial class APISALESORDERSRVASalesOrderItemBillingPlanTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemBillingPlanTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderItemBillingPlanTypeUpdate(bool? billingPlanIsInHeader = default(bool?), string billingPlanStartDate = default(string), string billingPlanStartDateRule = default(string), string referenceBillingPlan = default(string))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItemBillingPlanTypeUpdate {\n");
