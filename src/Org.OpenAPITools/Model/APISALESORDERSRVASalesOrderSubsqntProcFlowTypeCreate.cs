...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderSubsqntProcFlowType-create")]
    public partial class APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate(string salesOrder = default(string), Guid docRelationshipUUID = default(Guid), string subsequentDocument = default(string), string subsequentDocumentCategory = default(string), string processFlowLevel = default(string), string overallSDProcessStatus = default(string), string creationDate = default(string), string creationTime = default(string), string lastChangeDate = default(string), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate))
        {
            // to ensure "salesOrder" is required (not null)
            if (salesOrder == null)
            {
                throw new ArgumentNullException("salesOrder is a required property for APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate {\n");
