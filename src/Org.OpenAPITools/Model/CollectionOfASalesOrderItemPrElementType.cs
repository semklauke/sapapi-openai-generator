...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Collection_of_A_SalesOrderItemPrElementType")]
    public partial class CollectionOfASalesOrderItemPrElementType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfASalesOrderItemPrElementType" /> class.
        /// </summary>
        ...
        public CollectionOfASalesOrderItemPrElementType(string count = default(string), List<APISALESORDERSRVASalesOrderItemPrElementType> results = default(List<APISALESORDERSRVASalesOrderItemPrElementType>))
        {
            this.Count = count;
