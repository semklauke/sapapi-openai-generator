...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderItemPartnerAddressType-create")]
    public partial class APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate" /> class.
        /// </summary>
        /// <param name="salesOrder">Sales and Distribution Document Number (required).</param>
        /// <param name="salesOrderItem">Item number of the SD document (required).</param>
        /// <param name="partnerFunction">partnerFunction (required).</param>
        /// <param name="addressRepresentationCode">Version ID for International Addresses (required).</param>
        ...
        public APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate(string salesOrder = default(string), string salesOrderItem = default(string), string partnerFunction = default(string), string addressRepresentationCode = default(string), string correspondenceLanguage = default(string), string addresseeFullName = default(string), string organizationName1 = default(string), string organizationName2 = default(string), string organizationName3 = default(string), string organizationName4 = default(string), string cityName = default(string), string districtName = default(string), string postalCode = default(string), string streetName = default(string), string streetPrefixName1 = default(string), string streetPrefixName2 = default(string), string streetSuffixName1 = default(string), string streetSuffixName2 = default(string), string houseNumber = default(string), string country = default(string), string region = default(string), string formOfAddress = default(string), string taxJurisdiction = default(string), string transportZone = default(string), string pOBox = default(string), string pOBoxPostalCode = default(string), string emailAddress = default(string), string mobilePhoneCountry = default(string), string mobileNumber = default(string), string phoneNumberCountry = default(string), string phoneNumber = default(string), string phoneExtensionNumber = default(string), string faxNumberCountry = default(string), string faxAreaCodeSubscriberNumber = default(string), string faxExtensionNumber = default(string), APISALESORDERSRVASalesOrderItemPartnerTypeCreate toPartner = default(APISALESORDERSRVASalesOrderItemPartnerTypeCreate), APISALESORDERSRVASalesOrderTypeCreate toSalesOrder = default(APISALESORDERSRVASalesOrderTypeCreate), APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = default(APISALESORDERSRVASalesOrderItemTypeCreate))
        {
            // to ensure "salesOrder" is required (not null)
            if (salesOrder == null)
            {
                throw new ArgumentNullException("salesOrder is a required property for APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate and cannot be null");
            }
            this.SalesOrder = salesOrder;
            // to ensure "salesOrderItem" is required (not null)
            if (salesOrderItem == null)
            {
                throw new ArgumentNullException("salesOrderItem is a required property for APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate and cannot be null");
            }
            this.SalesOrderItem = salesOrderItem;
            // to ensure "partnerFunction" is required (not null)
            if (partnerFunction == null)
            {
                throw new ArgumentNullException("partnerFunction is a required property for APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate and cannot be null");
            }
            this.PartnerFunction = partnerFunction;
            // to ensure "addressRepresentationCode" is required (not null)
            if (addressRepresentationCode == null)
            {
                throw new ArgumentNullException("addressRepresentationCode is a required property for APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Item number of the SD document</value>
        ...
        [DataMember(Name = "AddressRepresentationCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        public APISALESORDERSRVASalesOrderItemPartnerTypeCreate ToPartner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderItemPartnerAddressTypeCreate {\n");
