...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "API_SALES_ORDER_SRV.A_SalesOrderRelatedObjectType-update")]
    public partial class APISALESORDERSRVASalesOrderRelatedObjectTypeUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APISALESORDERSRVASalesOrderRelatedObjectTypeUpdate" /> class.
        /// </summary>
        ...
        public APISALESORDERSRVASalesOrderRelatedObjectTypeUpdate(string sDDocumentRelatedObjectType = default(string), string sDDocRelatedObjectSystem = default(string), string sDDocRelatedObjectReference1 = default(string), string sDDocRelatedObjectReference2 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class APISALESORDERSRVASalesOrderRelatedObjectTypeUpdate {\n");
